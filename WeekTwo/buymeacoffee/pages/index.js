...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Buy DavDotsol a Coffee!</title>
        <meta name="description" content="Tipping site" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main className={styles.main}>
        <h1 className={styles.title}>Buy DavDotsol a Coffee!</h1>
        ...
        {currentAccount ? (
          <div>
            <form>
              ...
              <br />
              <div>
                <label>Send DavDotsol a message</label>
                <br />
              ...
              <div>
                <button type="button" onClick={() => buyCoffee('0.003')}>
                  Buy a large coffee for 0.003ETH
                </button>
              </div>
            </form>
          </div>
